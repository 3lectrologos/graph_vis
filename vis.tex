...
\begin{tikzpicture}[
  scale=1,
  nodestyle/.style={circle,draw=darkgray!80!white,line width=0.6pt,fill=darkgray,minimum size=0pt,inner sep=0, anchor=center},
  axisstyle/.style={darkgray!80!white, line width=0.6pt}
  ]
